...
export default function InfiniteScroll({
  ...
  return (
    ...
    >
      {/* Gradient Overlays */}
      <div className="absolute top-0 left-0 w-full h-1/4 bg-gradient-to-b from-zinc-900 to-transparent z-10 pointer-events-none"></div>
      <div className="absolute bottom-0 left-0 w-full h-1/4 bg-gradient-to-t from-zinc-900 to-transparent z-10 pointer-events-none"></div>
      ...
      >
        {items.map((item, i) => (
          <div
            className="flex items-center justify-center p-4 text-xl font-semibold text-center  bg-[#272727] rounded-[15px] select-none box-border relative"
            key={i}
            style={{
